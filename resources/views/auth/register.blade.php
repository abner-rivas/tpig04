<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="nombre_empresa" class="block mt-1 w-full" type="text" name="nombre_empresa" :value="old('nombre_empresa')" required autofocus autocomplete="nombre_empresa" />
        ...
        <div>
            ...
            <x-text-input id="rubro" class="block mt-1 w-full" type="text" name="rubro" :value="old('rubro')" required autofocus autocomplete="rubro" />
